...
public class Gun : MonoBehaviour
{
	...
	public void Shoot(Transform Target)
	{
		...
		{
			// Use an object pool instead for these! To keep this tutorial focused,
			// we'll skip implementing one. For more details you can see:
			// https://youtu.be/fsDE_mO4RZM or if using Unity 2021+:
			// https://youtu.be/zyzqA_CPz2E
	...
	{
		// This has been updated from the video implementation to fix a commonly raised
		// issue about the bullet trails moving slowly when hitting something close, and not
